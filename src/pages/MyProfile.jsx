...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    email: 'priyanshu.biswas9041@gmail.com',
    phone: '+91 - 9062655126',
    address: {
      line1: "21 street , Sewli, Mohan Pur",
      line2: "Near Old pipe factory , Barrackpore"
    },
    gender: 'Male',
    DOB: '2004-01-09'
  });
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div className='grid grid-cols-[1fr_3fr] gap-y2.5 mt-3 text-neutral-700'>
        ...
        {
          isEdit ?
            <input className='bg-gray-100 max w-52' type="text" value={userData.namphonee} onChange={e => setUserData(prev => ({ ...prev, phone: e.target.value }))}></input>
            :
